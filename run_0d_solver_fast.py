...
if __name__ == "__main__":
    ...
    use_custom_0d_elements = True
    custom_0d_elements_arguments_file_path = "./sample_special_user_defined_elements"
    ...
    # zero_d_simulation_results_file_path = zero_d_solver_input_file_path[:-4] + "_all_results.npy"
    # zero_d_results_for_var_names_loaded = np.load(zero_d_simulation_results_file_path, allow_pickle = True).item()
    # print("Starting comparison between true and loaded now...")
    # comparing_true_to_loaded(zero_d_results_for_var_names, zero_d_results_for_var_names_loaded)
    # zero_d_results_for_var_names = zero_d_results_for_var_names_loaded
    # print("Comparison completed.")




    zero_d_cap_results = extract_0d_cap_results(zero_d_results_for_var_names)

    # print("list(zero_d_cap_results[inlet][flow].keys()) = ", list(zero_d_cap_results["inlet"]["flow"].keys()))
    # print("list(zero_d_cap_results[outlet][flow].keys()) = ", list(zero_d_cap_results["outlet"]["flow"].keys()))
    zero_d_cap_results = collapse_inlet_and_outlet_0d_results(zero_d_cap_results)
    # print("list(zero_d_cap_results[flow].keys()) = ", list(zero_d_cap_results["flow"].keys()))

    # segment_number = 1
    # qoi = "pressure"
    # plt.figure()
    # plt.plot(zero_d_cap_results["time"], zero_d_cap_results[qoi][segment_number])
    # plt.title(qoi)
    #
    # qoi = "flow"
    # plt.figure()
    ...
    # sys.exit("done with 0d code")



    # for non-collapsed solutions:
    # for cap_type in ["inlet", "outlet"]:
    #     for qoi in list(zero_d_cap_results[cap_type].keys()):
    #         for segment_number in list(zero_d_cap_results[cap_type][qoi].keys()):
    ...
    #             print("\nzero_d_cap_results[cap_type][qoi][segment_number] = ", zero_d_cap_results[cap_type][qoi][segment_number])
    #             input("--------------------\n--------------------")
    # print("time = ", zero_d_cap_results["time"])
    # print("zero_d_cap_results.keys() = ", zero_d_cap_results.keys())
    # print("zero_d_cap_results[cap_type].keys() = ", zero_d_cap_results[cap_type].keys())
    # print("zero_d_cap_results[cap_type][qoi].keys() = ", zero_d_cap_results[cap_type][qoi].keys())
    # print("\ndone with everything")



    # for collapsed solutions:
    # for qoi in ["flow", "pressure", "wss"]:
    #     for segment_number in list(zero_d_cap_results[qoi].keys()):
    #         print("qoi = ", qoi)
    #         print("segment_number = ", segment_number)
    #         print("\nzero_d_cap_results[qoi][segment_number] = ", zero_d_cap_results[qoi][segment_number])
    #         input("--------------------\n--------------------")
    # print("time = ", zero_d_cap_results["time"])
    # print("zero_d_cap_results.keys() = ", zero_d_cap_results.keys())
    # print("zero_d_cap_results[qoi].keys() = ", zero_d_cap_results[qoi].keys())
    # print("\ndone with everything")



    # 0172_0001_0d coronary
    # segment_number = 3
    # qoi = "flow"
    # conversion = 0.06
    # plt.figure()
    # plt.plot(zero_d_cap_results["time"], zero_d_cap_results[qoi][segment_number]*conversion)
    # plt.show()
    ...
    # conversion = 1.0/1333.32
    # plt.figure()
    # plt.plot(zero_d_cap_results["time"], zero_d_cap_results["pressure"][segment_number]*conversion)
    # plt.show()
    ...
    # qoi = "flow"
    # plt.subplot(1, 2, 1)
    # plt.plot(zero_d_cap_results["time"], zero_d_cap_results[qoi][1], label = "outlet")
    # plt.title(qoi)
    # plt.legend()
